...
| Dépôt | Usage | Contenu |
|-------|-------|---------|
| **GitHub** ([ede-bzh/architekt-factory-platform](https://github.com/ede-bzh/architekt-factory-platform)) | Plateforme publique | Tout le code, agents, workflows. Assaini : 0 donnée projet, 0 info personnelle |
