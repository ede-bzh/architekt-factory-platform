...
_LOCAL_PROJECTS: list[dict] = [
    ...
    {"id": "logs-facteur", "name": "MailOps — Carrier Support N1", "path": "", "factory_type": "sf",
    ...
    {"id": "solaris", "name": "Solaris Design System", "path": "", "factory_type": "sf",
     "domains": ["svelte"], "description": "Enterprise design system (Figma + Svelte)"},
