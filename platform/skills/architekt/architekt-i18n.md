---
name: Architekt i18n
description: Doctrine internationalisation Architekt (locale, RTL, ICU, timezone, currency)
tags: [i18n, architekt, rtl, locale]
metadata:
  category: i18n
  triggers: [intake, ui, rtl, translation, locale]
---
